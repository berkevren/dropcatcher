namespace DropCatcher
{
    public class StringConstants
    {
        ...
        public static class TargetDivs
        {
            ...
            public static readonly string YuyuteiMarvelSR = "//li[@class='card_unit rarity_SR']  ";
            ...
            public static readonly string YuyuteiKadokawaSR = "//li[@class='card_unit rarity_SR']  ";
        }

        public static class TargetUrls
        {
            public static readonly string YuyuteiMarvel = "https://yuyu-tei.jp/game_ws/sell/sell_price.php?name=&vers%5B%5D=mar&rare=&type=&kizu=0";
            public static readonly string YuyuteiMarvelScratched = "https://yuyu-tei.jp/game_ws/sell/sell_price.php?name=&vers%5B%5D=mar&rare=&type=&kizu=1";
            ...
            public static readonly string YuyuteiKadokawaScratched = "https://yuyu-tei.jp/game_ws/sell/sell_price.php?name=&vers%5B%5D=kadokawas&rare=&type=&kizu=1";
        }
    }
}
